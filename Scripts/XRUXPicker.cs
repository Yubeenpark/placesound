...
namespace Microsoft.Azure.SpatialAnchors.Unity.Examples
{
    ...
    public class XRUXPicker : MonoBehaviour
    {
       ...
       /* public Text feedbackBox;
        ...
        private void Update()
        {
          /*  setActive.onClick.AddListener(() => { MobileAndEditorUXTree.SetActive(true);Debug.Log(" 들림!"); });
            setFalse.onClick.AddListener(() => { MobileAndEditorUXTree.SetActive(false); Debug.Log(" 들림!"); });*/
